...
if CLIENT then
    ...
    net.Receive("Manhunt_SyncConfig", function()
        ...
        print("[Manhunt] [CL] Received SyncConfig: GameTime=" .. Manhunt.Config.GameTime .. " Interval=" .. Manhunt.Config.Interval .. " Rounds=" .. (Manhunt.Config.Rounds or 1) .. " Tutorial=" .. tostring(Manhunt.Config.TutorialEnabled) .. " Zone=" .. tostring(Manhunt.Config.ZoneEnabled))
    end)
