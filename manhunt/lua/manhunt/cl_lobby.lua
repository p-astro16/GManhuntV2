...
hook.Add("HUDPaint", "Manhunt_LobbyHUD", function()
    ...
    -- Don't draw classic lobby in chase mode (chase has its own countdown HUD)
    if Manhunt.IsChaseMode() and Manhunt.Chase and Manhunt.Chase.ChaseActive then return end
